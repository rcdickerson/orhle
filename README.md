...
install` from the project's root directory. The executable takes as
argument a single `.imp` file. You can either run the executable
generated by Stack directly, or use Stack to execute ORHLE:
