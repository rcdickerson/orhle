module Orhle.InvGen.SearchQueueConc
  ( Entry(..)
  , Queue(..)
  , ScoreFunction
  , qEmpty
...
sfBalanced (Entry candidate rejectedBads acceptedGoods) =
  let
