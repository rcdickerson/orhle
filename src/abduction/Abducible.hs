...
fvmReplacementTerm :: FreshVarMapping -> Abducible -> Z3 AST
...
fvmFromAbducibles :: [Abducible] -> Z3 FreshVarMapping
...
fvmFlatten :: FreshVarMapping -> AST -> Z3 AST
fvmFlatten fvm phi = foldM flattenAbd phi (fvmOrigAbds fvm)
  where
    flattenAbd :: AST -> Abducible -> Z3 AST
